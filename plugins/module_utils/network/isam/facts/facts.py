...
FACT_RESOURCE_SUBSETS = dict(
    ...
    xstp=XstpFacts,
    alarm=AlarmFacts,
    isam_traps=Isam_trapsFacts,    interface_cages=InterfaceCagesFacts,)    ntp_onts=Ntp_ontsFacts,    qos_maps=Qos_mapsFacts,)    system=Isam_systemFacts,    isam_vlan_global=Isam_vlan_globalFacts,)
