#!/usr/bin/python
MODULE_DESCRIPTION = """
module: isam_pppoe_client_ppp_profile
short_description: Manage Nokia ISAM PPPoE client PPP profiles
description: Manage Nokia ISAM PPPoE client PPP profiles.
options:
  config:
    type: list
  running_config:
...
def main():
    ...
    module.exit_json(**PppoeClient(module, "profile").execute_module())
