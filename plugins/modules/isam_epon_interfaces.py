...
description: Manages the documented EPON interface provisioning subset.
options:
...
DOCUMENTATION = """
module: isam_epon_interfaces
short_description: Manage Nokia ISAM EPON interfaces
description: Manage Nokia ISAM EPON interfaces.
"""
